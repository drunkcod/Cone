...
namespace Cone.Runners
{
	...
	public class TeamCityLoggerSpec
	{
		...
		public void suite_starting() {
			...
			Check.That(() => Result.Last() == "##teamcity[testSuiteStarted name='Namespace.SuiteName']");
		}
		...
		public void suite_finished() {
			...
			Check.That(() => Result.Last() == "##teamcity[testSuiteFinished name='Namespace.SuiteName']");
		}
		...
		public void test_started() {
			...
			Check.That(() => Result.Last() == "##teamcity[testStarted name='MyTest']");		
		}
		...
		public void test_finished() {
			...
			Check.That(() => Result.Last() == "##teamcity[testFinished name='MyTest']");
		}
		...
		public void test_ignored() {
			...
			Check.That(() => Result.Any(line => line == "##teamcity[testIgnored name='MyTest' message='Teh Reason!']"));
			Check.That(() => Result.Last() == "##teamcity[testFinished name='MyTest']");
		}
		...
		public void comparision_test_failed() {
			var test = Test().InContext("Namespace.SuiteName").WithName("MyTest");
			Logger.BeginSuite(Suite().WithName("Namespace.SuiteName"))
				.WithTestLog(test, log => log.Failure(new ConeTestFailure(test.TestName, new CheckFailed(new[]{ new FailedExpectation("Teh Error!", Maybe<object>.Some(1), Maybe<object>.Some(2)) }, null), FailureType.Test)));		
