			...
			class NUnitMethodClassifier : MethodClassifier
			{
				...
				protected override void ClassifyCore(Invokable method) {
					...
					if(method.ReturnType == typeof(void) && attributeNames.Contains("NUnit.Framework.TestAttribute")) {
						...
						Test(method, attributes, new ConeTestMethodContext(expectsException == null ? ExpectedTestResult.None : ExpectedTestResult.Exception((Type)expectsException.GetPropertyValue("ExpectedException"), false), NoCategories));
					}
